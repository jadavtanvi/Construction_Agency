...
<%
    ...
    if (email != null && passw != null) {
        String sql = "SELECT * FROM loginreg WHERE Email=? AND Password=? AND Role='Worker' AND Is_Active=1 and status='Approved'";
        ...
        if (rs.next()) {
            ...
            out.println("popup.innerHTML = '<h2>Invalid Login</h2><p>Invalid username or password. Please try again.</p><button onclick=\"window.location.href=\\'workerlogin.html\\';\">Close</button>';");
