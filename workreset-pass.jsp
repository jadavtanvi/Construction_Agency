        ...
        <%
                ...
                try {
                	...
                	if(pw.equals(cpw)){
                        ...
                        response.sendRedirect("popup.jsp?message=Password+Not+Match!&redirect=workerreset.jsp"); 
                    }
                    ...
                    if (rs.next()) 
                    {
                       ...
                       if(rst>0)
                       {
                    	   response.sendRedirect("popup.jsp?message=Password+Updated+Successfully!&redirect=workerlogin.html"); 
                       } 
                       
                    }
        			else {
                        
                        response.sendRedirect("popup.jsp?message=Email+Not+Found!&redirect=workerlogin.html"); 
                    }
                } catch (Exception e) {
